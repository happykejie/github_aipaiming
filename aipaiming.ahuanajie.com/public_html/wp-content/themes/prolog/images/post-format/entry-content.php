            ...
            <ul>
                ...
                <?php if ( ! post_password_required() && ( comments_open() || get_comments_number() ) ) : ?>
                    <li class="comments-link">
                        <i class="fa fa-comments-o"></i> <?php comments_popup_link( '<span class="leave-reply">' . __( '没有评论', 'themeum' ) . '</span>', __( '一条评论', 'themeum' ), __( '% 评论', 'themeum' ) ); ?>
                    </li>
                ...
                <?php if (isset($themeum_options['blog-edit-en']) && $themeum_options['blog-edit-en']) { ?>
                    <li class="edit-link">
                         <?php edit_post_link( __( '编辑', 'themeum' ), '<span class="edit-link"><i class="fa fa-edit"></i>', '</span>' ); ?>
                    </li>
                <?php } ?>
            </ul>
        </div> <!--/.entry-meta -->
