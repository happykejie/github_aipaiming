                        ...
                        <?php get_template_part( 'post-format/content', get_post_format() ); ?>
                         ...
                         <?php if ( isset($themeum_options['post-nav-en']) && $themeum_options['post-nav-en'] ) { ?>
                            <div class="clearfix post-navigation">
                                <?php previous_post_link('<span class="btn-style previous-post pull-left">%link</span>','<i class="fa fa-long-arrow-left"></i> 上一篇'); ?>
                                 <?php next_post_link('<span class="btn-style next-post pull-right">%link</span>','下一篇 <i class="fa fa-long-arrow-right"></i>'); ?>
                            </div> <!-- .post-navigation -->
                        <?php } ?>
