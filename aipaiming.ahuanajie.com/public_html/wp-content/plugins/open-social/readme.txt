...
1. 免费版功能完善稳定，如无BUG基本停止更新
2. 付费版 Open Social Pro: **RMB 50**，**QQ** 提供技术支持
3. 购买请扫描**支付宝**二维码支付，下载连接邮箱发送
4. 购买后请添加**QQ**并注明邮箱方便沟通和支持

### 升级过渡 ###

1. 付费版在后台插件列表名字依然为 **Open Social**，最低版本 **1.7**，页面标识为 **open-social**
2. 免费版在后台插件列表名字为 Open Social，最高版本为 1.6.4，页面标识为 open-social/open-social
